...
data=r"C:\Anderson\Pessoal\01_Doutorado\10_Testes\36_Subdomain_Dular_2009_magnetic\FFEM_Complete\results\line_field.txt"
data = np.genfromtxt(data,delimiter=' ')
B_comp_x=(data[:,0])
B_comp_y=(data[:,1])
B_comp_z=(data[:,2])
...
##===================================================
## BS
data=r"C:\Anderson\Pessoal\01_Doutorado\10_Testes\36_Subdomain_Dular_2009_magnetic\FFEM_Complete\results\line_field_BS.txt"
data = np.genfromtxt(data,delimiter=' ')
B_BS_x=list()
B_BS_y=list()
B_BS_z=list()
