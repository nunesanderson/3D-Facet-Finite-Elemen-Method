...
data=r"C:\Anderson\Pessoal\01_Doutorado\10_Testes\31_Subdomain_Dular_2009\GetDP_2D\bLine.dat"
...
##===================================================
## FFEM completo
data=r"C:\Anderson\Pessoal\01_Doutorado\10_Testes\31_Subdomain_Dular_2009\FFEM_Complete\results\line_field.txt"
data = np.genfromtxt(data,delimiter=' ')
B_comp_x=(data[:,0])
B_comp_y=(data[:,1])
B_comp_z=(data[:,2])
...
##===================================================
## VS
data=r"C:\Anderson\Pessoal\01_Doutorado\10_Testes\31_Subdomain_Dular_2009\FFEM_VS\results\line_field.txt"
data = np.genfromtxt(data,delimiter=' ')
B_VS_x=(data[:,0])
B_VS_y=(data[:,1])
B_VS_z=(data[:,2])
...
##===================================================
## BS
data=r"C:\Anderson\Pessoal\01_Doutorado\10_Testes\31_Subdomain_Dular_2009\FFEM_VS\results\line_field_BS.txt"
data = np.genfromtxt(data,delimiter=' ')
B_BS_x=(data[:,0])*mu0
B_BS_y=(data[:,1])*mu0
B_BS_z=(data[:,2])*mu0
...
##===================================================
## VS + Correction
data=r"C:\Anderson\Pessoal\01_Doutorado\10_Testes\31_Subdomain_Dular_2009\FFEM_VS_corrected\results\line_field.txt"
data = np.genfromtxt(data,delimiter=' ')
B_VS_corr_x=(data[:,0])
B_VS_corry=(data[:,1])
B_VS_corrz=(data[:,2])
...
plt.plot(x_FEM, B_comp_y,label='FFEM - Ref.',color="black",lw=3,linestyle='-',alpha=0.5)
